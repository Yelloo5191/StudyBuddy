...
export default function AIUsage() {
  return (
    <div className="bg-seasalt-300 md:mt-24 mb-12 relative w-full max-w-md h-fit p-4 ml-auto lg:ml-10 mr-auto lg:mr-14 text-white flex flex-col items-center rounded-lg">
